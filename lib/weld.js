...
;(function(window) {
  ...
  var color = { gray: '\033[37m', darkgray: '\033[40;30m', red: '\033[31m', lightgreen: '\033[1;32m', yellow: '\033[1;33m', 
      ...
      if (debug) {
        ...
        function colorize(val) {
          ...
          if(val === 'false' || val === 'null' || val === 'undefined') {
            return color.red + parent + color.gray;
          }
          else {
            return color.cyan + val + color.gray;
          }
        }
