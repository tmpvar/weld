...
;(function(window) {
  ...
  */
  weld = function weld(collection, data, pconfig) {
    ...
    /*
      ...
      Objects:
        ...
        - recurse
    */
   window.walk = function walk(selected, key, data) {
      var result;
      ...
      // Array
        ...
        if (selected.length > 0) {
          ...
          var els = engine(remove), l = els.length;
    ...
    // start welding!
    return walk(collection, null, data);
  };
