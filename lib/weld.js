...
;(function(window) {
  ...
  */
  apply  = function(element, key, value) {
    ...
    weld.debug("APPLY - SELECT RESULT", key, child.outerHTML);
    ...
    */
    var walk = function(selected, key, data) {
      ...
      if (typeof data === "string") {
        ...
        return apply(selected[0], key, data);
          ...
          for (i = 0; i<data.length; i++) {
            ...
            */
            if (selected && selected.length > 0) {
              weld.debug("INSERTING", el.outerHTML, 'into', selected[0].tagName, selected[0].parentNode.className)
        ...
        for (var a in data) {
          if (data.hasOwnProperty(a)) {
            ...
            */
            ...
            weld.debug("OBJECT:", a, 'found', !!found);
            if (!found) {
              found = selected;
            }
            walk(found, a, data[a]);
